...
public class Homepage {
    ...
    public static String expectederror="Based on the details you've entered, we're unable to give you an estimate of your borrowing power with this calculator. For questions, call us on 1800 035 500.";
...
//      String getheadertext=application_type.getText();
//      assertEquals(applicationtype, getheadertext);
...
//      WebElement yi=driver.findElement(By.xpath("//div/span[@id='q2q1i1']/following-sibling::input"));
//      yi.sendKeys(income);
	}
